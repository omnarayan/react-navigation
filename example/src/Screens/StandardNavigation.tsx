...
function HomeScreen() {
  const navigation = useNavigation<typeof StandardStack>();
...

{
  ...
  type StandardStackNavigationList = NavigationListForNavigator<
    typeof StandardStack
  >;
...
export const StandardNavigation = {
  screen: StandardStack,
  title: 'Libraries - Standard Navigation',
};
